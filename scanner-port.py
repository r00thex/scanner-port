...
time.sleep(4)
print (f"""
{rd}[-]{yw} Creator channel Telegram: {Lgn}@roothexc
{rd}[!]{yw}To use, please enter https and http! 
Example : {gn} Telegram.com
""")
print ("")
time.sleep(2)
ip_address = input(f"{rd} ┌─["+f"{Lgn}@roothexc"+f"{be}/"+f"{we}port-scanner"+f"""{rd}]
...
print (f"{rd}[*]{gn} telegram account: {Lgn} https://t.me/roothexc")
